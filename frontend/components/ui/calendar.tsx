  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        caption: "flex justify-between items-center mb-4 relative px-1",
        caption_label: "text-sm font-semibold flex-1 text-center",
        ...
        day_selected:
          "bg-red-600 text-slate-50 hover:bg-red-600 hover:text-slate-50 focus:bg-red-600 focus:text-slate-50",
