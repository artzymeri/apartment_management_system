    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          fullscreen
            ? "inset-0 w-screen h-screen max-w-none max-h-none rounded-none border-0 flex"
            : "top-[50%] left-[50%] w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border p-6 sm:max-w-lg grid",
          className
        )}
        {...props}
      >
