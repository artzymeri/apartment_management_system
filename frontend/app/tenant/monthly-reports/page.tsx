        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
            <Alert className="border-emerald-200 bg-emerald-50 flex-1">
              ...
              <AlertTitle className="text-emerald-900">Rreth Raporteve Mujore</AlertTitle>
              <AlertDescription className="text-emerald-700">
                Raportet mujore tregojnë se si pagesat e qirasë shpërndahen në kategori të ndryshme të shpenzimeve dhe mirëmbajtjes së pronës.
              </AlertDescription>
            </Alert>
            ...
            <Card className="border-dashed">
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <h3 className="text-lg font-semibold text-slate-900 mb-2">
                  Nuk Ka Raporte të Disponueshme
                </h3>
                <p className="text-slate-600 text-center max-w-md">
                  Nuk ka raporte mujore të disponueshme për vitin {selectedYear}. Raportet gjenerohen nga menaxheri i pronës.
                </p>
              </CardContent>
            </Card>
          )}
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-slate-700">Buxheti Total</span>
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          {report.spending_breakdown.length > 3 && (
                            <p className="text-xs text-slate-500 italic">
                              +{report.spending_breakdown.length - 3} kategori të tjera
                            </p>
                          )}
                        </div>
                      </div>
